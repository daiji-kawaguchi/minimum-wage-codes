...
forvalues s=1/2{;
eststo: qui ivregress 2sls emp (lmw=lgap_d2004 lgap_d2005 lgap_d2006 lgap_d2008 lgap_d2009 lgap_d2010 lgap_d2011 lgap_d2012 lgap_d2013 lgap_d2014 lgap_d2015 lgap_d2016) ${control} ${fix} if sex==`s'&age>=19&age<=24, cluster(prefecture);
qui estadd ysumm;
eststo: qui ivregress 2sls emp (lmw=lgap_d2004 lgap_d2005 lgap_d2006 lgap_d2008 lgap_d2009 lgap_d2010 lgap_d2011 lgap_d2012 lgap_d2013 lgap_d2014 lgap_d2015 lgap_d2016) ${control} ${fix} if sex==`s'&age>=25&age<=59, cluster(prefecture);
qui estadd ysumm;
eststo: qui ivregress 2sls emp (lmw=lgap_d2004 lgap_d2005 lgap_d2006 lgap_d2008 lgap_d2009 lgap_d2010 lgap_d2011 lgap_d2012 lgap_d2013 lgap_d2014 lgap_d2015 lgap_d2016) ${control} ${fix} if sex==`s'&age>=60&age<=64, cluster(prefecture);
qui estadd ysumm;
};
esttab, b(2) t(2) keep(lmw) se nostar compress mtitles("M19-24" "M25-59" "M60-64" "F19-24" "F25-59" "F60-64");
...
forvalues s=1/2{;
eststo: qui ivregress 2sls emp (lmw= lgap_d2004 lgap_d2005 lgap_d2006 lgap_d2008 lgap_d2009 lgap_d2010 lgap_d2011 lgap_d2012 lgap_d2013 lgap_d2014 lgap_d2015 lgap_d2016) ${control} ${wo_fix} if sex==`s'&age>=19&age<=24, cluster(prefecture);
qui estadd ysumm;
eststo: qui ivregress 2sls emp (lmw= lgap_d2004 lgap_d2005 lgap_d2006 lgap_d2008 lgap_d2009 lgap_d2010 lgap_d2011 lgap_d2012 lgap_d2013 lgap_d2014 lgap_d2015 lgap_d2016) ${control} ${wo_fix} if sex==`s'&age>=25&age<=59, cluster(prefecture);
qui estadd ysumm;
eststo: qui ivregress 2sls emp (lmw= lgap_d2004 lgap_d2005 lgap_d2006 lgap_d2008 lgap_d2009 lgap_d2010 lgap_d2011 lgap_d2012 lgap_d2013 lgap_d2014 lgap_d2015 lgap_d2016) ${control} ${wo_fix} if sex==`s'&age>=60&age<=64, cluster(prefecture);
qui estadd ysumm;
};
esttab, b(2) t(2) keep(lmw) se nostar compress mtitles("M19-24" "M25-59" "M60-64" "F19-24" "F25-59" "F60-64");
esttab using "${path}\out\crossreg_coll.tex", append label b(2) t(2) 
...
forvalues s=1/2{;
eststo: qui ivregress 2sls emp (lmw= lgap_d2004 lgap_d2005 lgap_d2006 lgap_d2008 lgap_d2009 lgap_d2010 lgap_d2011 lgap_d2012 lgap_d2013 lgap_d2014 lgap_d2015 lgap_d2016) `control2' ${fix} if sex==`s'&age>=19&age<=24, cluster(prefecture);
qui estadd ysumm;
eststo: qui ivregress 2sls emp (lmw= lgap_d2004 lgap_d2005 lgap_d2006 lgap_d2008 lgap_d2009 lgap_d2010 lgap_d2011 lgap_d2012 lgap_d2013 lgap_d2014 lgap_d2015 lgap_d2016) `control2' ${fix} if sex==`s'&age>=25&age<=59, cluster(prefecture);
qui estadd ysumm;
eststo: qui ivregress 2sls emp (lmw= lgap_d2004 lgap_d2005 lgap_d2006 lgap_d2008 lgap_d2009 lgap_d2010 lgap_d2011 lgap_d2012 lgap_d2013 lgap_d2014 lgap_d2015 lgap_d2016) `control2' ${fix} if sex==`s'&age>=60&age<=64, cluster(prefecture);
qui estadd ysumm;
};
esttab, b(2) t(2) keep(lmw) se nostar compress mtitles("M19-24" "M25-59" "M60-64" "F19-24" "F25-59" "F60-64");
